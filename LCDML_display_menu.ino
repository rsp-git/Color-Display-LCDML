    ...
    do
    {
      ...
      if (tmp->checkCondition())
      {
        ...
        if(tmp->checkType_menu() == true)
        {
          ...
          display.setCursor(10, _LCDML_ADAFRUIT_FONT_H * (n));
...
/* ******************************************************************** */
{
  // TFT nur leeren wenn Seite Wechselt
        ...
        if(tmp->checkType_menu() == true)
        {
          ...
          // Normaler Menüeintrag
            ...
            if(LCDML.MENU_getCursorPos()==n)
              display.setTextColor(_LCDML_ADAFRUIT_HIGHLIGHT_COLOR); 
            else
              display.setTextColor(_LCDML_ADAFRUIT_TEXT_COLOR); 
            display.println(content_text);
          /*if (LCDML.DISP_checkMenuCursorUpdate()) {
          } else {
            display.fillRect(0, _LCDML_ADAFRUIT_FONT_H * (n), 16,  _LCDML_ADAFRUIT_FONT_H, _LCDML_ADAFRUIT_BACKGROUND_COLOR);
          }*/
